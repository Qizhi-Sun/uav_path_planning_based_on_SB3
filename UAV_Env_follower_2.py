...
class UAVEnv_F2(gym.Env):
    def __init__(self, uav_num, map_w, map_h, map_z, Init_state, buildings, model):
        ...
        self.model_leader = model[0]
        self.model_follower = model[1]
        self.done = False
...
class Render:
    def __init__(self, uav_num, buildings, map_w, map_h, map_z, uav_r, position_pool, match_pairs):
        self.uav_num = uav_num
        self.buildings = buildings
        self.map_w = map_w
        self.map_h = map_h
